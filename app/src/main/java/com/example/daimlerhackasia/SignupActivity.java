                    ...
                    firebaseAuth.createUserWithEmailAndPassword(emailID, paswd).addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                Toast.makeText(SignupActivity.this,"Try Different Credentials ",Toast.LENGTH_SHORT).show();
                            } else {
                                Intent UserActiv = new Intent(SignupActivity.this, MainActivity.class);
